        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-md-8 col-sm-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('post.posts.update', $post->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description"
                                        placeholder="{{ __('Write Post Description here...') }}" rows="5" required>{{ old('description', $post->description) }}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-sl-8 col-md-8 col-sm-8">
                                        ...
                                        <input type="text" class="form-control" name="tag"
                                            value="{{ old('tag', $tags) }}" placeholder="Tags (comma separated)">
                                        @error('tag')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
